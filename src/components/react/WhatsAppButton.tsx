...
const WhatsAppButton: React.FC = () => {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-6 bg-white text-black text-sm font-bold px-5 py-3 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-2xl border-l-4 border-whatsapp">
        Reserva VIP por WhatsApp
      </span>
    </a>
  );
};
